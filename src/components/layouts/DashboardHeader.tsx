      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-3 relative">
          ...
          <div ref={notificationsRef} className="relative">
            ...
            {isNotificationsOpen && (
              <div className="absolute right-0 mt-2 w-80 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-lg shadow-slate-900/10 text-sm">
                ...
                <div className="max-h-72 overflow-y-auto">
                  {demoNotifications.map((item) => (
                    <div
                      key={item.id}
                      className="px-4 py-3 border-b last:border-b-0 border-slate-100 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800/60 cursor-pointer"
                    >
          ...
          <div ref={profileRef} className="relative">
            ...
            {isProfileOpen && (
              <div className="absolute right-0 mt-2 w-52 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-lg shadow-slate-900/10 text-sm py-1">
                ...
                <div className="border-t border-slate-200 dark:border-slate-800 mt-1 pt-1">
                  <Link
                    href="/login"
                    className="block px-3 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20"
                  >
                    Logout
                  </Link>
                </div>
